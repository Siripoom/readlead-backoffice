...
export const WALLET_CHANNELS: WalletChannel[] = [
  { id: 'proof-upload', label: 'อัปโหลดหลักฐาน', description: 'แนบสลิปเพื่อรออนุมัติ', kind: 'slip', defaultEnabled: true, platforms: ['web'] },
  { id: 'promptpay', label: 'พร้อมเพย์', description: 'สแกน QR จ่ายทันที', kind: 'gateway', provider: 'omise', instrument: 'promptpay', defaultEnabled: true, platforms: ['web'] },
  { id: 'credit-card', label: 'บัตรเครดิต/เดบิต', description: 'Visa, Mastercard', kind: 'gateway', provider: 'omise', instrument: 'card', defaultEnabled: true, platforms: ['web'] },
  { id: 'truemoney', label: 'ทรูมันนี่ วอลเล็ท', description: 'TrueMoney Wallet', kind: 'gateway', provider: 'omise', instrument: 'truemoney', defaultEnabled: true, platforms: ['web'] },
  { id: 'shopeepay', label: 'ShopeePay', description: 'จ่ายผ่าน ShopeePay', kind: 'gateway', provider: 'omise', instrument: 'shopeepay', defaultEnabled: true, platforms: ['web'] },
  ...
  { id: 'apple-pay', label: 'Apple Pay', description: 'จ่ายด้วย Apple Pay', kind: 'gateway', provider: 'omise', instrument: 'apple-pay', defaultEnabled: true, platforms: ['web', 'ios'] },
  ...
  { id: 'google-pay', label: 'Google Pay', description: 'จ่ายด้วย Google Pay', kind: 'gateway', provider: 'omise', instrument: 'google-pay', defaultEnabled: true, platforms: ['web', 'android'] },
  ...
  { id: 'google-play', label: 'Google Play', description: 'ซื้อผ่าน Google Play', kind: 'iap', store: 'google-play', defaultEnabled: false, platforms: ['android'] },
  { id: 'app-store', label: 'App Store', description: 'ซื้อผ่าน App Store', kind: 'iap', store: 'app-store', defaultEnabled: false, platforms: ['ios'] },
]
